...
class ExtractedImage:
     ...
     def to_base64(self) -> str:
          return base64.b64decode(self.image_data).decode()
...
class PaperChunk:
    ...
    """
      ...
      def __post_init__(self):
            ...
            #Ensure all the expected metadata fields exist
            default_metadata = {
                 'paper_id' : None,
                 'paper_url' : None,
                 'page_num' : None,
      ...
      def get_section(self) -> Optional[str]:
           #GET THE SECTION IDENTIFIER IF YOU CAN
      ...
      def from_dict(cls,data:Dict) -> 'PaperChunk':
          """Create a PaperChunk from a dictionary"""
          return cls(
              text = data['text'],
